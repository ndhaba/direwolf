...
let tests = "Text Parsing" >::: [
  ...
  test_parse_fail "x 2";
  test_parse_fail "x 5 z (1 + 2)";
  (* Explicit Multiplication/Division *)
  test_parse (ExplicitMult [l 2.; l 3.; l 4.; l 5.]) "2 * 3 *4* 5";
  test_parse (ExplicitMult [ImplicitMult [l 5.; s "x"]; l 9.]) "5x*9";
  test_parse (Divide (s "x", l 2.)) "x/2";
  test_parse (Divide (Divide (Divide (l 1., l 2.), l 3.), l 4.)) "1 / 2 /3/ 4";
  ...
  test_parse (Add [l 1.; l 2.]) "1+2";
  test_parse (Add [l 9.; l 10.; l 21.; l 42.]) "9 + 10 +21+ 42";
  test_parse (Subtract (l 90., l 9.)) "90-9";
  test_parse (Subtract (Subtract (Subtract (l 10., l 1.), l 1.), l 1.)) "10 - 1 -1- 1";
